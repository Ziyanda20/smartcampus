...
import ScheduleView from './components/lecturers/ScheduleView';
import StudentMaintenancePage from './components/Maintenance/StudentMaintenancePage';
import NotificationsPage from './components/notifications/NotificationsPage';
import LecturerAnnouncementsPage from './components/lecturers/LecturerAnnouncementsPage';
import LecturerBookingPage from './components/lecturers/LecturerBookingPage';
        ...
        <BrowserRouter>
          <Routes>
            ...
            {/*<Route element={<ProtectedRoute allowedRoles={['lecturer', 'admin']} />}>*/}
              ...
              <Route path="/lecturer/:id/announcements" element={<LecturerAnnouncementsPage />} />
            </Route>
            ...
            <Route element={<ProtectedRoute allowedRoles={['lecturer']} />}>
              <Route path="/lecturer/bookings" element={<LecturerBookingPage />} />
            </Route>
